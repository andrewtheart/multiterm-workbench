...
- Right-click a page for **Rename**, **New page**, **Close page**, **Close other pages**, and **Close all**. Close other pages keeps only the page you right-clicked and makes it active; Close all resets the workspace to one empty **Page 1**. Both close entries are hidden when a single page is left.
