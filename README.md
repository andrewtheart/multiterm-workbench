...
**⬇️ [Download MultiTerm Workbench v0.1.16](https://github.com/andrewtheart/multiterm-workbench/releases/tag/v0.1.16)** — Windows installer, from the [releases page](https://github.com/andrewtheart/multiterm-workbench/releases).
...
- [MultiTerm-Setup-0.1.16.exe](https://github.com/andrewtheart/multiterm-workbench/releases/download/v0.1.16/MultiTerm-Setup-0.1.16.exe)
