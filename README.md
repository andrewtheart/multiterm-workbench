...
**⬇️ [Download MultiTerm Workbench v0.1.20](https://github.com/andrewtheart/multiterm-workbench/releases/tag/v0.1.20)** — Windows installer, from the [releases page](https://github.com/andrewtheart/multiterm-workbench/releases).
...
- [MultiTerm-Setup-0.1.20.exe](https://github.com/andrewtheart/multiterm-workbench/releases/download/v0.1.20/MultiTerm-Setup-0.1.20.exe)
