...
**⬇️ [Download MultiTerm Workbench v0.1.17](https://github.com/andrewtheart/multiterm-workbench/releases/tag/v0.1.17)** — Windows installer, from the [releases page](https://github.com/andrewtheart/multiterm-workbench/releases).
...
- [MultiTerm-Setup-0.1.17.exe](https://github.com/andrewtheart/multiterm-workbench/releases/download/v0.1.17/MultiTerm-Setup-0.1.17.exe)
